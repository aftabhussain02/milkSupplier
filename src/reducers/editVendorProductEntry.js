...
export default (state = intState, action) => {
  switch (action.type) {
    case INITIALIZE_EDIT_VENDOR_PRODUCT_ENTRY:
      return { ...state, ...action.payload };
    case UPDATE_EDIT_VENDOR_PRODUCT_ENTRY_PROPS:
      return { ...state, [action.payload.prop]: action.payload.value };

    case EDIT_VENDOR_PRODUCT_ENTRY_ATTEMPT:
      return { ...state, error: {}, loading: true, errorMessage: '' };

    case EDIT_VENDOR_PRODUCT_ENTRY_ERROR:
      return {
        ...state,
    ...
    case EDIT_VENDOR_PRODUCT_ENTRY_SUCCESS:
